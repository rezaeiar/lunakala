                ...
                <div className="flex flex-col gap-3">
                    <div className="flex justify-between items-center">
                        <div className="flex justify-between md:justify-start w-full md:w-auto gap-6 lg:gap-8">
                            <div className="flex xl:hidden items-center text-gray-700">
                            ...
                            <Link href='/' className="flex md:hidden items-center gap-1 text-gray-700">
                        ...
                        <div className="gap-4 lg:gap-6 hidden md:flex">
                            <Link href='/account/login' className="flex rounded-md border border-gray-300 font-dana">
                                <div className="my-1.5 px-4 text-gray-700 border-l border-gray-400 text-sm lg:text-base">
                                    ورود
                                </div>
                                <div className="my-1.5 px-4 text-gray-700 text-sm lg:text-base">
                                    ثبت نام
                                </div>
                            </Link>
                            <CartButton />
